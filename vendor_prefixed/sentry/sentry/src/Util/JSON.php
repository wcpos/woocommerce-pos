...
use WCPOS\Vendor\Sentry\Exception\JsonException;
/**
...
final class JSON
{
    ...
    public static function encode($data, int $options = 0, int $maxDepth = 512) : string
    {
        ...
        if (\defined('WCPOS\\Vendor\\JSON_ERROR_NON_BACKED_ENUM')) {
            $allowedErrors[] = \WCPOS\Vendor\JSON_ERROR_NON_BACKED_ENUM;
        }
