...
use DOMXPath;
use WCPOS\Vendor\Dompdf\Frame\Factory;
use WCPOS\Vendor\Dompdf\Frame\FrameTree;
use WCPOS\Vendor\Dompdf\Image\Cache;
use WCPOS\Vendor\Dompdf\Css\Stylesheet;
use WCPOS\Vendor\Dompdf\Helpers;
use WCPOS\Vendor\Masterminds\HTML5;
/**
...
class Dompdf
{
    ...
    public function render()
    {
        ...
        if (\WCPOS\Vendor\Dompdf\Helpers::lengthEqual($canvasWidth, $size[2]) === \false || \WCPOS\Vendor\Dompdf\Helpers::lengthEqual($canvasHeight, $size[3]) === \false) {
            $this->canvas = CanvasFactory::get_instance($this, $this->paperSize, $this->paperOrientation);
    ...
    public function setPaper($size, string $orientation = "portrait") : self
    {
        ...
        if (\WCPOS\Vendor\Dompdf\Helpers::lengthEqual($current_size[2], $new_size[2]) === \false || \WCPOS\Vendor\Dompdf\Helpers::lengthEqual($current_size[3], $new_size[3]) === \false) {
            $this->canvas = CanvasFactory::get_instance($this, $this->paperSize, $this->paperOrientation);
        }
        return $this;
    }
