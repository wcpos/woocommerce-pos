...
if (!\class_exists(\WCPOS\Vendor\YahnisElsts\PluginUpdateChecker\v5p2\Scheduler::class, \false)) {
    /**
    ...
    class Scheduler
    {
        ...
        public function __construct($updateChecker, $checkPeriod, $hourlyHooks = array('load-plugins.php'))
        {
            ...
            if ($this->checkPeriod > 0) {
                ...
                if (!wp_next_scheduled($this->cronHook) && !\defined('WP_INSTALLING')) {
                    ...
                    if (\function_exists('WCPOS\\Vendor\\wp_rand')) {
        ...
        )
        {
            ...
            if (\is_a($this->updateChecker, \WCPOS\Vendor\YahnisElsts\PluginUpdateChecker\v5p2\Theme\UpdateChecker::class)) {
            ...
            if (\is_a($this->updateChecker, \WCPOS\Vendor\YahnisElsts\PluginUpdateChecker\v5p2\Plugin\UpdateChecker::class)) {
