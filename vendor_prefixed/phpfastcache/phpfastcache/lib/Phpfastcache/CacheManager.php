...
use WCPOS\Vendor\Phpfastcache\Exceptions\PhpfastcacheDriverNotFoundException;
use WCPOS\Vendor\Phpfastcache\Exceptions\PhpfastcacheInstanceNotFoundException;
use WCPOS\Vendor\Phpfastcache\Exceptions\PhpfastcacheInvalidArgumentException;
use WCPOS\Vendor\Phpfastcache\Exceptions\PhpfastcacheInvalidConfigurationException;
use WCPOS\Vendor\Phpfastcache\Exceptions\PhpfastcacheLogicException;
use WCPOS\Vendor\Phpfastcache\Exceptions\PhpfastcacheUnsupportedOperationException;
use WCPOS\Vendor\Phpfastcache\Util\ClassNamespaceResolverTrait;
/**
 * Class CacheManager
...
class CacheManager
{
    ...
    {
        if (!\is_a($driverClass, ExtendedCacheItemPoolInterface::class, \true)) {
    ...
    public static function addCustomDriver(string $driverName, string $className) : void
    {
        ...
        if (\in_array($driverName, self::getDriverList(), \true)) {
    ...
    public static function addCoreDriverOverride(string $driverName, string $className) : void
    {
        ...
        if (!\is_subclass_of($className, self::CORE_DRIVER_NAMESPACE . $driverName . '\\Driver', \true)) {
