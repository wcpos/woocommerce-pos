 ...
 */
namespace WCPOS\Vendor\Dompdf\Renderer;

use DOMElement;
use WCPOS\Vendor\Dompdf\Adapter\CPDF;
use WCPOS\Vendor\Dompdf\Css\Color;
...
abstract class AbstractRenderer
{
    ...
    protected function _background_image(string $url, float $x, float $y, float $width, float $height, Style $style) : void
    {
        ...
        if (!$cached) {
            ...
            $bgBytes = $bg_width * $bg_height * 4 * 4;
            // 4 channels with 4 bytes per channel (e.g. truecolor with alpha)
