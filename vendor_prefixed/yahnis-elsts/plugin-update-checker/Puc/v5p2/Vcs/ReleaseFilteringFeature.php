...
if (!\trait_exists(\WCPOS\Vendor\YahnisElsts\PluginUpdateChecker\v5p2\Vcs\ReleaseFilteringFeature::class, \false)) {
    trait ReleaseFilteringFeature
    {
         ...
         */
        protected $releaseFilterByType = \WCPOS\Vendor\YahnisElsts\PluginUpdateChecker\v5p2\Vcs\Api::RELEASE_FILTER_SKIP_PRERELEASE;
        /**
         ...
         * @return $this
         */
        public function setReleaseFilter($callback, $releaseTypes = \WCPOS\Vendor\YahnisElsts\PluginUpdateChecker\v5p2\Vcs\Api::RELEASE_FILTER_SKIP_PRERELEASE, $maxReleases = 20)
        {
            if ($maxReleases > 100) {
         ...
         */
        public function setReleaseVersionFilter($regex, $releaseTypes = \WCPOS\Vendor\YahnisElsts\PluginUpdateChecker\v5p2\Vcs\Api::RELEASE_FILTER_SKIP_PRERELEASE, $maxReleasesToExamine = 20)
        {
        ...
        protected function shouldSkipPreReleases()
        {
            ...
            //more release types.
            return $this->releaseFilterByType !== \WCPOS\Vendor\YahnisElsts\PluginUpdateChecker\v5p2\Vcs\Api::RELEASE_FILTER_ALL;
        }
        /**
         * @return bool
         */
