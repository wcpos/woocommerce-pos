...
namespace WCPOS\Vendor\Phpfastcache\Drivers\Memstatic;
...
class Driver implements ExtendedCacheItemPoolInterface
{
    ...
    public function getStats() : DriverStatistic
    {
        ...
        $stat->setInfo('[Memstatic] A memory static driver')->setSize(\mb_strlen(\serialize($this->staticStack)))->setData(\implode(', ', \array_keys($this->itemInstances)))->setRawData($this->staticStack);
        return $stat;
    }
    /**
     * @return bool
