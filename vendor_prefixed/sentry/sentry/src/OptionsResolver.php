...
use WCPOS\Vendor\Sentry\Util\Arr;
/**
...
class OptionsResolver
{
     ...
     * @return array<string, mixed>
     */
    public function resolveOnly(array $override = [], array $options = [], ?LoggerInterface $logger = null) : array
    {
     ...
     * @return array<string, mixed>
     */
    private function applyOptions(array $resolved, array $defaults, array $options, string $parentPath, ?LoggerInterface $logger) : array
    {
        /** @mago-ignore analysis:mixed-assignment */
