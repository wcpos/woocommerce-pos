...
<div>
	<p class="form-row form-row-full">
		<label
			for="variable_pos_visibility[<?php echo esc_attr( (string) $variation->ID ); ?>]"><?php /* translators: Product POS visibility label in WooCommerce admin. */ esc_html_e( 'POS visibility', 'woocommerce-pos' ); ?></label>
