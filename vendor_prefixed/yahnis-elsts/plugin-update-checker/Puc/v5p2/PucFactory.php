...
use WCPOS\Vendor\YahnisElsts\PluginUpdateChecker\v5p2\Vcs;
if (!\class_exists(\WCPOS\Vendor\YahnisElsts\PluginUpdateChecker\v5p2\PucFactory::class, \false)) {
    /**
    ...
    class PucFactory
    {
        ...
        {
            if (\function_exists('WCPOS\\Vendor\\wp_normalize_path')) {
        ...
        protected static function isPluginFile($absolutePath)
        {
            ...
            if (\function_exists('WCPOS\\Vendor\\get_file_data')) {
