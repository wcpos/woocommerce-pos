...
class LogLevel
{
    ...
    public function toPsrLevel() : string
    {
        switch ($this->value) {
            case 'trace':
            case 'debug':
                return \WCPOS\Vendor\Psr\Log\LogLevel::DEBUG;
            case 'warn':
                return \WCPOS\Vendor\Psr\Log\LogLevel::WARNING;
            case 'error':
                return \WCPOS\Vendor\Psr\Log\LogLevel::ERROR;
            case 'fatal':
                return \WCPOS\Vendor\Psr\Log\LogLevel::CRITICAL;
            case 'info':
            default:
                return \WCPOS\Vendor\Psr\Log\LogLevel::INFO;
        }
    }
