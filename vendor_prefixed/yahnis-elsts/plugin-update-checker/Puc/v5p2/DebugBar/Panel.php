...
if (!\class_exists(\WCPOS\Vendor\YahnisElsts\PluginUpdateChecker\v5p2\DebugBar\Panel::class, \false) && \class_exists('WCPOS\\Vendor\\Debug_Bar_Panel', \false)) {
    class Panel extends \WCPOS\Vendor\Debug_Bar_Panel
    {
        /** @var UpdateChecker */
