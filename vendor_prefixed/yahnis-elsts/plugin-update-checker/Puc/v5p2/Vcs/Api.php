...
use WCPOS\Vendor\PucReadmeParser;
if (!\class_exists(\WCPOS\Vendor\YahnisElsts\PluginUpdateChecker\v5p2\Vcs\Api::class, \false)) {
    abstract class Api
    {
        ...
        public function getRemoteReadme($ref = 'master')
        {
            ...
            $parser = new \WCPOS\Vendor\PucReadmeParser();
        ...
        public function getRemoteChangelog($ref, $localDirectory)
        {
            ...
            return \WCPOS\Vendor\Parsedown::instance()->text($changelog);
        }
        /**
