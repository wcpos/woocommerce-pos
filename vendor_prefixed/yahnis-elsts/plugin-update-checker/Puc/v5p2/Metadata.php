...
if (!\class_exists(\WCPOS\Vendor\YahnisElsts\PluginUpdateChecker\v5p2\Metadata::class, \false)) {
    /**
    ...
    abstract class Metadata
    {
        ...
        protected static function createFromJson($json, $target)
        {
            ...
            if (empty($apiResponse) || !\is_object($apiResponse)) {
                ...
                do_action('puc_api_error', new \WCPOS\Vendor\WP_Error('puc-invalid-json', $errorMessage));
