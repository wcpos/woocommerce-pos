...
use WCPOS\Vendor\Sentry\HttpClient\Request;
use WCPOS\Vendor\Sentry\Options;
use WCPOS\Vendor\Sentry\Serializer\PayloadSerializerInterface;
use WCPOS\Vendor\Sentry\Spotlight\SpotlightClient;
/**
 * @internal
 */
