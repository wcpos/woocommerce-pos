...
use WCPOS\Vendor\YahnisElsts\PluginUpdateChecker\v5p2\Plugin;
if (!\class_exists(\WCPOS\Vendor\YahnisElsts\PluginUpdateChecker\v5p2\Vcs\PluginUpdateChecker::class, \false)) {
    class PluginUpdateChecker extends \WCPOS\Vendor\YahnisElsts\PluginUpdateChecker\v5p2\Plugin\UpdateChecker implements \WCPOS\Vendor\YahnisElsts\PluginUpdateChecker\v5p2\Vcs\BaseChecker
    {
        ...
        public function requestInfo($unusedParameter = null)
        {
            ...
            $info = new \WCPOS\Vendor\YahnisElsts\PluginUpdateChecker\v5p2\Plugin\PluginInfo();
