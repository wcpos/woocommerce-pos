...
/**
 * The wcpos/v2 pass-through of the v1 Tax_Classes_Controller service — identical behavior,
 * versioned namespace (map #544 boundary ruling: everything under one version).
 */
class Tax_Classes_Controller extends \WCPOS\WooCommercePOS\API\V1\Tax_Classes_Controller {
	/**
	 * Endpoint namespace.
	 *
	 * @var string
