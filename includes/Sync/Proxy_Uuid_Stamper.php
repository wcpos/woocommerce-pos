...
final class Proxy_Uuid_Stamper {
	 ...
	 * helper feeds both term resources.
	 */
	...
	private static function stamp_proxy_generic( $data, $resource, array $config ) {
		...
		/** @var array<int, string> $seen */ // phpcs:ignore Generic.Commenting.DocComment.MissingShort -- narrow the bulk_read closure return for PHPStan.
