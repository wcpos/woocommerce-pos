...
use WCPOS\Vendor\YahnisElsts\PluginUpdateChecker\v5p2\PucFactory;
use WCPOS\Vendor\YahnisElsts\PluginUpdateChecker\v5p2\UpdateChecker;
if (!\class_exists(\WCPOS\Vendor\YahnisElsts\PluginUpdateChecker\v5p2\DebugBar\Extension::class, \false)) {
    class Extension
    {
        const RESPONSE_BODY_LENGTH_LIMIT = 4000;
        /** @var UpdateChecker */
        protected $updateChecker;
        protected $panelClass = \WCPOS\Vendor\YahnisElsts\PluginUpdateChecker\v5p2\DebugBar\Panel::class;
        ...
        private function getLibraryUrl($filePath)
        {
            ...
            $absolutePath = \WCPOS\Vendor\YahnisElsts\PluginUpdateChecker\v5p2\PucFactory::normalizePath($absolutePath);
            $pluginDir = \WCPOS\Vendor\YahnisElsts\PluginUpdateChecker\v5p2\PucFactory::normalizePath(WP_PLUGIN_DIR);
            $muPluginDir = \WCPOS\Vendor\YahnisElsts\PluginUpdateChecker\v5p2\PucFactory::normalizePath(WPMU_PLUGIN_DIR);
            $themeDir = \WCPOS\Vendor\YahnisElsts\PluginUpdateChecker\v5p2\PucFactory::normalizePath(get_theme_root());
