...
function GatewayRow({ item, index, data, mutate, proEnabled, onEditGateway }: GatewayRowProps) {
	...
	return (
		...
		>
			...
			<td className="wcpos:px-4 wcpos:py-2 wcpos:text-ellipsis wcpos:overflow-hidden">
				...
				<table className="wcpos:min-w-full wcpos:divide-y wcpos:divide-gray-200">
					<thead className="wcpos:bg-gray-50">
						<tr>
							...
							<th
								scope="col"
								className="wcpos:px-4 wcpos:py-2 wcpos:text-left wcpos:text-xs wcpos:font-medium wcpos:text-gray-500 wcpos:uppercase wcpos:tracking-wider wcpos:text-center"
							>
								{t('common.default')}
							</th>
							<th
								scope="col"
								className="wcpos:px-4 wcpos:py-2 wcpos:text-left wcpos:text-xs wcpos:font-medium wcpos:text-gray-500 wcpos:uppercase wcpos:tracking-wider wcpos:text-left"
							>
								{t('common.gateway')}
							</th>
							<th
