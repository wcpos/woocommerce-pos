...
<div class="meta">
	<table>
		<tr>
			...
			<td><?php echo esc_html( $receipt_data['order']['number'] ?? $receipt_data['meta']['order_number'] ?? '' ); ?></td>
		</tr>
		<tr>
			<td><?php esc_html_e( 'Date', 'woocommerce-pos' ); ?></td>
			<td><?php echo esc_html( $receipt_data['order']['created']['datetime'] ?? '' ); ?></td>
		</tr>
...
<!-- Notes -->
<?php if ( ! empty( $receipt_data['order']['customer_note'] ) || ! empty( $receipt_data['meta']['customer_note'] ) ) : ?>
	<div class="notes">
		<h3><?php esc_html_e( 'Customer Notes', 'woocommerce' ); ?></h3>
		<p><?php echo wp_kses_post( nl2br( $receipt_data['order']['customer_note'] ?? $receipt_data['meta']['customer_note'] ) ); ?></p>
	</div>
<?php endif; ?>
