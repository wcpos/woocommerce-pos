...
class Config extends ConfigurationOption
{
    ...
    public function setDatabase(string $database) : Config
    {
        ...
        throw new PhpfastcacheInvalidArgumentException(\sprintf("Error: illegal_database_name Name: '%s'. Only lowercase characters (a-z), digits (0-9), and any of the characters _, \$, (, ), +, -, and / are allowed. Must begin with a letter.", $database));
    }
    /**
     * @return string
     */
