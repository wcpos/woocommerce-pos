...
if (!\class_exists(\WCPOS\Vendor\YahnisElsts\PluginUpdateChecker\v5p2\Vcs\GitLabApi::class, \false)) {
    class GitLabApi extends \WCPOS\Vendor\YahnisElsts\PluginUpdateChecker\v5p2\Vcs\Api
    {
        ...
        public function getLatestRelease()
        {
            ...
            foreach ($releases as $release) {
                ...
                return new \WCPOS\Vendor\YahnisElsts\PluginUpdateChecker\v5p2\Vcs\Reference(array('name' => $release->tag_name, 'version' => $versionNumber, 'downloadUrl' => $downloadUrl, 'updated' => $release->released_at, 'apiResponse' => $release));
            }
            return null;
        }
        /**
        ...
        public function getLatestTag()
        {
            ...
            $tag = $versionTags[0];
            return new \WCPOS\Vendor\YahnisElsts\PluginUpdateChecker\v5p2\Vcs\Reference(array('name' => $tag->name, 'version' => \ltrim($tag->name, 'v'), 'downloadUrl' => $this->buildArchiveDownloadUrl($tag->name), 'apiResponse' => $tag));
        }
        /**
        ...
        protected function api($url, $queryParams = array())
        {
            ...
            $error = new \WCPOS\Vendor\WP_Error('puc-gitlab-http-error', \sprintf('GitLab API error. URL: "%s",  HTTP status code: %d.', $baseUrl, $code));
        ...
        public function enableReleasePackages()
        {
            $this->enableReleaseAssets(
                /** @lang RegExp */
                '/\\.zip($|[?&#])/i',
                \WCPOS\Vendor\YahnisElsts\PluginUpdateChecker\v5p2\Vcs\Api::REQUIRE_RELEASE_ASSETS
            );
        }
