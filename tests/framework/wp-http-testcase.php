...
abstract class WP_HTTP_TestCase extends WP_UnitTestCase {
	 ...
	 * @var array  The request arguments.
	 *             }
	 *
	 * @since 1.0.0
	 *
	 ...
	 * @since 1.1.0
	 */
	public static function save_cache(): void {
	 ...
	 * @param string $url     The URL the request is for.
	 *
	 * @return false|string The cache key for the request. False if not caching.
	 */
	 ...
	 */
	protected function cache_response( $cache_key, $response ): void {
		if ( ! self::$use_caching ) {
			return;
		}
	 ...
	 */
	protected static function load_env( $var, $is_bool = false ): void {
	 ...
	 * @since 1.1.0
	 */
	protected static function load_cache(): void {
		if ( ! self::$use_caching ) {
			return;
		}
