 ...
 */
namespace WCPOS\Vendor\Symfony\Component\OptionsResolver\Debug;

use WCPOS\Vendor\Symfony\Component\OptionsResolver\Exception\NoConfigurationException;
use WCPOS\Vendor\Symfony\Component\OptionsResolver\Exception\UndefinedOptionsException;
use WCPOS\Vendor\Symfony\Component\OptionsResolver\OptionsResolver;
/**
...
class OptionsResolverIntrospector
{
    ...
    {
        \WCPOS\Vendor\trigger_deprecation('symfony/options-resolver', '5.1', 'The "%s()" method is deprecated, use "getDeprecation()" instead.', __METHOD__);
