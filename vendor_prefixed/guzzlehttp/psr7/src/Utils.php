...
final class Utils
{
     ...
     * throws.
     */
    public static function redactUriForMessage(#[\SensitiveParameter] UriInterface $uri) : string
    {
        try {
            $raw = (string) $uri;
        } catch (\Throwable $e) {
     ...
     */
    public static function redactUriStringForMessage(#[\SensitiveParameter] string $uri) : string
    {
        try {
