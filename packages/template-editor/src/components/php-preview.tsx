...
export function PhpPreview({ previewUrl }: PhpPreviewProps) {
	...
	if (!previewUrl) {
		return (
			<div className="wcpos:w-[360px] wcpos:shrink-0 wcpos:border wcpos:border-gray-300 wcpos:bg-gray-50 wcpos:flex wcpos:items-center wcpos:justify-center wcpos:p-6 wcpos:text-sm wcpos:text-gray-500">
