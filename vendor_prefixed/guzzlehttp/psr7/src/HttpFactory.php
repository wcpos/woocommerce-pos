...
use WCPOS\Vendor\Psr\Http\Message\ResponseFactoryInterface;
use WCPOS\Vendor\Psr\Http\Message\ResponseInterface;
use WCPOS\Vendor\Psr\Http\Message\ServerRequestFactoryInterface;
use WCPOS\Vendor\Psr\Http\Message\ServerRequestInterface;
use WCPOS\Vendor\Psr\Http\Message\StreamFactoryInterface;
use WCPOS\Vendor\Psr\Http\Message\StreamInterface;
use WCPOS\Vendor\Psr\Http\Message\UploadedFileFactoryInterface;
use WCPOS\Vendor\Psr\Http\Message\UploadedFileInterface;
use WCPOS\Vendor\Psr\Http\Message\UriFactoryInterface;
