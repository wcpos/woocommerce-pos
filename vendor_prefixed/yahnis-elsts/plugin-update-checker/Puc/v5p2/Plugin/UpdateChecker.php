...
namespace WCPOS\Vendor\YahnisElsts\PluginUpdateChecker\v5p2\Plugin;

use WCPOS\Vendor\YahnisElsts\PluginUpdateChecker\v5p2\InstalledPackage;
use WCPOS\Vendor\YahnisElsts\PluginUpdateChecker\v5p2\UpdateChecker as BaseUpdateChecker;
use WCPOS\Vendor\YahnisElsts\PluginUpdateChecker\v5p2\Scheduler;
use WCPOS\Vendor\YahnisElsts\PluginUpdateChecker\v5p2\DebugBar;
if (!\class_exists(\WCPOS\Vendor\YahnisElsts\PluginUpdateChecker\v5p2\Plugin\UpdateChecker::class, \false)) {
    /**
     ...
     * @access public
     */
    class UpdateChecker extends \WCPOS\Vendor\YahnisElsts\PluginUpdateChecker\v5p2\UpdateChecker
    {
        ...
        public function __construct($metadataUrl, $pluginFile, $slug = '', $checkPeriod = 12, $optionName = '', $muPluginFile = '')
        {
            ...
            $this->extraUi = new \WCPOS\Vendor\YahnisElsts\PluginUpdateChecker\v5p2\Plugin\Ui($this);
        }
        /**
        ...
        {
            $scheduler = new \WCPOS\Vendor\YahnisElsts\PluginUpdateChecker\v5p2\Scheduler($this, $checkPeriod, array('load-plugins.php'));
        ...
        {
            list($pluginInfo, $result) = $this->requestMetadata(\WCPOS\Vendor\YahnisElsts\PluginUpdateChecker\v5p2\Plugin\PluginInfo::class, 'request_info', $queryArgs);
            if ($pluginInfo !== null) {
        ...
        public function requestUpdate()
        {
            ...
            $update = \WCPOS\Vendor\YahnisElsts\PluginUpdateChecker\v5p2\Plugin\Update::fromPluginInfo($pluginInfo);
        ...
        {
            return new \WCPOS\Vendor\YahnisElsts\PluginUpdateChecker\v5p2\DebugBar\PluginExtension($this);
        }
        /**
        ...
        {
            return new \WCPOS\Vendor\YahnisElsts\PluginUpdateChecker\v5p2\Plugin\Package($this->pluginAbsolutePath, $this);
        }
        /**
         * @return Package
         */
