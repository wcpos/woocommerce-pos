...
namespace WCPOS\Vendor\Phpfastcache\Helper;

use DateInterval;
use DateTime;
use WCPOS\Vendor\Phpfastcache\CacheManager;
...
use WCPOS\Vendor\Phpfastcache\Exceptions\PhpfastcacheRootException;
use WCPOS\Vendor\Phpfastcache\Exceptions\PhpfastcacheSimpleCacheException;
use WCPOS\Vendor\Psr\SimpleCache\CacheInterface;
use Traversable;
/**
 * Class Psr16Adapter
...
class Psr16Adapter implements CacheInterface
{
    ...
    public function getMultiple($keys, $default = null)
    {
        ...
        try {
            return \array_map(static function (ExtendedCacheItemInterface $item) use($default) {
