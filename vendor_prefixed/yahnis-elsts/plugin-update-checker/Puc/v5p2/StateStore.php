...
if (!\class_exists(\WCPOS\Vendor\YahnisElsts\PluginUpdateChecker\v5p2\StateStore::class, \false)) {
    class StateStore
    {
        /**
         ...
         * @return $this
         */
        public function setUpdate(\WCPOS\Vendor\YahnisElsts\PluginUpdateChecker\v5p2\Update $update = null)
        {
            $this->lazyLoad();
            $this->update = $update;
            return $this;
        ...
        public function save()
        {
            ...
            if (isset($this->update)) {
                ...
                if (\WCPOS\Vendor\YahnisElsts\PluginUpdateChecker\v5p2\Utils::startsWith($updateClass, $prefix)) {
        ...
        protected function load()
        {
            ...
            $this->lastCheck = \intval(\WCPOS\Vendor\YahnisElsts\PluginUpdateChecker\v5p2\Utils::get($state, 'lastCheck', 0));
            $this->checkedVersion = \WCPOS\Vendor\YahnisElsts\PluginUpdateChecker\v5p2\Utils::get($state, 'checkedVersion', '');
            $this->update = null;
