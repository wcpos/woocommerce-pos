...
if (!\trait_exists(\WCPOS\Vendor\YahnisElsts\PluginUpdateChecker\v5p2\Vcs\ReleaseAssetSupport::class, \false)) {
    trait ReleaseAssetSupport
    {
         ...
         * @var int
         */
        protected $releaseAssetPreference = \WCPOS\Vendor\YahnisElsts\PluginUpdateChecker\v5p2\Vcs\Api::PREFER_RELEASE_ASSETS;
        /**
         ...
         */
        public function enableReleaseAssets($nameRegex = null, $preference = \WCPOS\Vendor\YahnisElsts\PluginUpdateChecker\v5p2\Vcs\Api::PREFER_RELEASE_ASSETS)
        {
