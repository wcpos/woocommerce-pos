...
class WC_Unit_Test_Case extends WP_HTTP_TestCase {
	 ...
	 */
	public function throwAnException( $message = null, $code = null ): void {
	 ...
	 */
	public function reset_container_resolutions(): void {
	 ...
	 */
	public function reset_container_replacements(): void {
	 ...
	 */
	public function reset_legacy_proxy_mocks(): void {
		wc_get_container()->get( LegacyProxy::class )->reset();
	}
	 ...
	 */
	public function register_legacy_proxy_function_mocks( array $mocks ): void {
	 ...
	 * @throws \Exception Invalid parameter.
	 */
	public function register_legacy_proxy_static_mocks( array $mocks ): void {
	 ...
	 * @throws \Exception Invalid parameter.
	 */
	public function register_legacy_proxy_class_mocks( array $mocks ): void {
	 ...
	 */
	public function register_legacy_proxy_global_mocks( array $mocks ): void {
	 ...
	 * @param null|float $delta    The maximum allowed difference, defaults to DEFAULT_FLOAT_COMPARISON_DELTA.
	 * @param string     $message  An optional error message to use if the assertion fails.
	 */
	public function assertFloatEquals( $expected, $actual, ?float $delta = null, string $message = '' ): void {
	 ...
	 */
	protected static function disable_code_hacker(): void {
	 ...
	 */
	protected static function reenable_code_hacker(): void {
	 ...
	 */
	protected function assertOutputsHTML( $expected, $callable, $message = '' ): void {
	 ...
	 * @param string $message  Optional error message to display if the assertion fails.
	 */
	protected function assertEqualsHTML( $expected, $actual, $message = '' ): void {
	 ...
	 */
	protected function skip_on_php_8_1(): void {
	 ...
	 */
	protected function skip_if_hpos_enabled( $message ): void {
