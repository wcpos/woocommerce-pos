...
if (!\class_exists(\WCPOS\Vendor\YahnisElsts\PluginUpdateChecker\v5p2\Plugin\Package::class, \false)) {
    class Package extends \WCPOS\Vendor\YahnisElsts\PluginUpdateChecker\v5p2\InstalledPackage
    {
        /**
         * @var UpdateChecker
         */
        ...
        public function getPluginHeader()
        {
            ...
            if (!\function_exists('WCPOS\\Vendor\\get_plugin_data')) {
        ...
        public function isMuPlugin()
        {
            ...
            if ($cachedResult === null) {
                ...
                if ($muPluginDir === \false || $pluginPath === \false) {
                    ...
                    $pluginPath = \WCPOS\Vendor\YahnisElsts\PluginUpdateChecker\v5p2\PucFactory::normalizePath($this->pluginAbsolutePath);
                }
