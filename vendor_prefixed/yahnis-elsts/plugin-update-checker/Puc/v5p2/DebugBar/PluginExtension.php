...
if (!\class_exists(\WCPOS\Vendor\YahnisElsts\PluginUpdateChecker\v5p2\DebugBar\PluginExtension::class, \false)) {
    class PluginExtension extends \WCPOS\Vendor\YahnisElsts\PluginUpdateChecker\v5p2\DebugBar\Extension
    {
        /** @var UpdateChecker */
        protected $updateChecker;
        public function __construct($updateChecker)
        {
            parent::__construct($updateChecker, \WCPOS\Vendor\YahnisElsts\PluginUpdateChecker\v5p2\DebugBar\PluginPanel::class);
