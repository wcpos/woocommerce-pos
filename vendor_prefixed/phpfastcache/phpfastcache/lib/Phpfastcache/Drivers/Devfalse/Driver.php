...
namespace WCPOS\Vendor\Phpfastcache\Drivers\Devfalse;
...
class Driver implements ExtendedCacheItemPoolInterface
{
    ...
    public function getStats() : DriverStatistic
    {
        ...
        $stat->setInfo('[Devfalse] A void info string')->setSize(0)->setData(\implode(', ', \array_keys($this->itemInstances)))->setRawData(\false);
        return $stat;
    }
    /**
    ...
    {
        return [self::DRIVER_DATA_WRAPPER_INDEX => \false, self::DRIVER_TAGS_WRAPPER_INDEX => [], self::DRIVER_EDATE_WRAPPER_INDEX => new DateTime()];
    }
    /**
     * @param CacheItemInterface $item
     * @return bool
