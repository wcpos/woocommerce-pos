...
namespace WCPOS\Vendor\Psr\Log\Test;

use WCPOS\Vendor\Psr\Log\LoggerInterface;
use WCPOS\Vendor\Psr\Log\LogLevel;
use WCPOS\Vendor\PHPUnit\Framework\TestCase;
/**
...
abstract class LoggerInterfaceTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('WCPOS\\Vendor\\Psr\\Log\\LoggerInterface', $this->getLogger());
    }
    /**
    ...
    public function testObjectCastToString()
    {
        if (\method_exists($this, 'createPartialMock')) {
            $dummy = $this->createPartialMock('WCPOS\\Vendor\\Psr\\Log\\Test\\DummyTest', array('__toString'));
        } else {
            $dummy = $this->getMock('WCPOS\\Vendor\\Psr\\Log\\Test\\DummyTest', array('__toString'));
        }
