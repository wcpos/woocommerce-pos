...
class Receipt_I18n_Labels {
	...
	public static function get_labels(): array {
		return array(
			...
			'customer_tax_ids'       => __( 'Customer Tax IDs', 'woocommerce-pos' ),
			'tax_id_eu_vat'          => __( 'VAT Number', 'woocommerce-pos' ),
			'tax_id_gb_vat'          => __( 'VAT Number', 'woocommerce-pos' ),
			'tax_id_sa_vat'          => __( 'VAT Number', 'woocommerce-pos' ),
			'tax_id_au_abn'          => __( 'ABN', 'woocommerce-pos' ),
			'tax_id_br_cpf'          => __( 'CPF', 'woocommerce-pos' ),
			'tax_id_br_cnpj'         => __( 'CNPJ', 'woocommerce-pos' ),
			'tax_id_in_gst'          => __( 'GSTIN', 'woocommerce-pos' ),
			'tax_id_it_cf'           => __( 'Codice Fiscale', 'woocommerce-pos' ),
			'tax_id_it_piva'         => __( 'Partita IVA', 'woocommerce-pos' ),
			'tax_id_es_nif'          => __( 'NIF', 'woocommerce-pos' ),
			'tax_id_ar_cuit'         => __( 'CUIT', 'woocommerce-pos' ),
