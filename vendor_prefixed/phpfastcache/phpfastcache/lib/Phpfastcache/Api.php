...
class Api
{
     ...
     */
    public static function getPhpFastCacheVersion(bool $fallbackOnChangelog = \true, bool $cacheable = \true) : string
    {
        /**
     ...
     * @return string
     */
    public static function getPhpFastCacheGitHeadHash(bool $cacheable = \true) : string
    {
        static $hash;
        if ($hash && $cacheable) {
            return $hash;
