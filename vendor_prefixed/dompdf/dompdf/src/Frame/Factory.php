 ...
 */
namespace WCPOS\Vendor\Dompdf\Frame;
...
use WCPOS\Vendor\Dompdf\FrameDecorator\Page as PageFrameDecorator;
use WCPOS\Vendor\Dompdf\FrameReflower\Page as PageFrameReflower;
use WCPOS\Vendor\Dompdf\Positioner\AbstractPositioner;
use DOMXPath;
/**
...
class Factory
{
    ...
    public static function decorate_frame(Frame $frame, Dompdf $dompdf, ?Frame $root = null) : ?AbstractFrameDecorator
    {
        ...
        $decorator = "WCPOS\\Vendor\\Dompdf\\FrameDecorator\\{$decorator}";
        $reflower = "WCPOS\\Vendor\\Dompdf\\FrameReflower\\{$reflower}";
    ...
    protected static function getPositionerInstance(string $type) : AbstractPositioner
    {
        if (!isset(self::$_positioners[$type])) {
            $class = '\\WCPOS\\Vendor\\Dompdf\\Positioner\\' . $type;
