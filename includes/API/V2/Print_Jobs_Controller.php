...
/**
 * The wcpos/v2 pass-through of the v1 Print_Jobs_Controller service — identical behavior,
 * versioned namespace (map #544 boundary ruling: everything under one version).
 */
class Print_Jobs_Controller extends \WCPOS\WooCommercePOS\API\V1\Print_Jobs_Controller {
	/**
	 * Endpoint namespace.
	 *
	 * @var string
